...
import { AlertTriangle, Loader2, MessageSquare, Mail, Phone, Clock } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className={`text-xl font-semibold text-[${DARK_TEXT}]`}>{message.name}</p>
            </div>
            ...
            <div>
              ...
              <p className={`text-xl font-semibold text-[${DARK_TEXT}]`}>{message.email}</p>
            </div>
            ...
            <div>
              ...
              <p className={`text-xl font-semibold text-[${DARK_TEXT}]`}>{message.phone || "N/A"}</p>
            </div>
            ...
            <div>
              ...
              <span className={`text-base px-4 py-1 rounded-full font-semibold bg-[${ACCENT}/10] text-[${ACCENT}]`}>
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="flex items-center mb-2">
                <p className="text-sm font-medium text-gray-500">Contenu du message</p>
            </div>
            <div className={`p-4 bg-gray-50 rounded-lg border border-gray-200`}>
                <p className={`text-lg leading-relaxed text-[${DARK_TEXT}] whitespace-pre-wrap`}>{message.message}</p>
            </div>
          </div>
          ...
          <div className="pt-4">
            <div className="flex items-center mb-1">
              ...
              <p className="text-sm font-medium text-gray-500">Date de réception</p>
            </div>
            <p className={`text-lg font-medium text-[${DARK_TEXT}]`}>{formatDate(message.createdAt)}</p>
          </div>
