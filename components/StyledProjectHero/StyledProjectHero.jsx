  ...
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="md:order-1 space-y-4">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight" style={{ color: '#333333' }}>
        ...
        <div className="flex flex-wrap gap-2 pt-4">
          {categories?.map((cat) => (
            <span
              ...
              style={{ backgroundColor: '#6495ED1A', color: '#6495ED', borderColor: '#6495ED4D' }}
            >
              {cat}
            </span>
          ))}
