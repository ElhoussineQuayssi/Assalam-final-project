  ...
  <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
    {loading ? (
      <div className="flex justify-center items-center p-12">
        <div className="animate-spin rounded-full h-8 w-8 border-4 border-transparent border-t-current" style={{ color: '#6495ED' }} />
                ...
                {columns.map((column) => (
                  ...
                  >
                    {column.render
                      ...
                      : (column.key === 'title' ? <p className="font-semibold">{item[column.key]}</p> : item[column.key])
                    }
                  </td>
                ))}
