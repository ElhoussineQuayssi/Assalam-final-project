        ...
        >
            <Link href={`/blogs/${post.slug}`} className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 p-8 flex flex-col justify-center">
                    ...
                    <h2 className="text-3xl font-bold mb-3" style={{ color: '#333333' }}>{post.title}</h2>
                    <p className="text-lg text-gray-700 mb-4 line-clamp-3">{post.excerpt}</p>
                    <span className="font-semibold" style={{ color: '#6495ED' }}>Découvrir le récit &rarr;</span>
                </div>
            </Link>
        </div>
    );
