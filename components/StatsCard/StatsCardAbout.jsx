const StatsCard = ({ title, value, color, description }) => (
  <div
    className={`card-lift bg-white rounded-xl p-6 shadow-lg border-t-4 text-center scroll-reveal transition-all duration-300 hover:shadow-lg hover:scale-[1.02]`}
