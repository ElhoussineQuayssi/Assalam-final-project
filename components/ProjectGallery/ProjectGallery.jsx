  ...
  <div className={`space-y-4 ${className} scroll-reveal`}>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
      {images.slice(0, 6).map((imageSrc, index) => (
        <div key={index} className="relative aspect-square rounded-xl overflow-hidden shadow-md group transition duration-300 hover:scale-[1.02] hover:shadow-xl scroll-reveal" style={{ animationDelay: `${index * 0.1}s` }}>
          <Image
            src={imageSrc}
